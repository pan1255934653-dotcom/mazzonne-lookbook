...
const steps: Step[] = [
  {
    ...
    lead: '整个流程唯一需要"拍"的一步：把样衣平铺，用手机在自然光下拍摄正反面与细节。不需要摄影棚、灯光或专业相机。',
    points: [
  ...
  {
    no: '04',
    title: '画布精修 · 让真实样衣"穿"上模特',
    tool: 'Lovart 画布 · AI 换装 / 局部修复 / 扩图',
    toolClass: 'bg-[#55624a] text-[#f2efe8]',
    lead: '底图进入 Lovart 画布后做四类精修——这是"AI 图"变成"品牌物料"的关键一步，所有修改都在画布上迭代，随时可回退、可重做。',
    points: [
      { k: 'AI 换装', v: '把第 01 步平拍的真实样衣精准"穿"到虚拟模特身上：版型、印花、铆钉位置逐一对齐' },
      { k: '替换模特 · 保持服装', v: '同一套衣服一键更换模特气质与面孔，服装与姿态保持不变——一套衣服多出片' },
      { k: '局部定点修复', v: '手部、领口等 AI 易出错区域单独框选重绘（如修正手部结构、外套无领设计）' },
